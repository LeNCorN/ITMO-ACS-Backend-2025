...
export class EducationController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Список записей об образовании успешно получен',
  ...
  @ApiResponse({
    status: 200,
    description: 'Запись об образовании успешно получена',
  }) // Описание успешного ответа
  ...
  @ApiResponse({
    status: 200,
    description: 'Запись об образовании успешно обновлена',
  }) // Описание успешного ответа
  @ApiResponse({ status: 400, description: 'Неверные данные' }) // Описание ошибки
  @ApiResponse({ status: 404, description: 'Запись об образовании не найдена' }) // Описание ошибки
  @ApiParam({
  ...
  @ApiResponse({
    status: 200,
    description: 'Запись об образовании успешно удалена',
  }) // Описание успешного ответа
  @ApiResponse({ status: 404, description: 'Запись об образовании не найдена' }) // Описание ошибки
  @ApiParam({
    name: 'id',
